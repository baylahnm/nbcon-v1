...
const mockProjects: Project[] = [
  {
    ...
    subtitle: 'Complete overhaul of company website',
    ownerId: '1',
  ...
  },
  {
    id: '2',
    name: 'Mobile App',
    subtitle: 'New iOS and Android application',
    ownerId: '2',
...
const mockProjectMembers: ProjectMember[] = [
  ...
  { projectId: '2', userId: '4', role: 'client', createdAt: '2024-01-10T00:00:00Z' },
];
...
const mockTaskAssignees: TaskAssignee[] = [
  ...
  { taskId: '3', userId: '3', assignedAt: '2024-01-12T00:00:00Z' },
];
