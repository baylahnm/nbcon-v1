/**
 * HomePage Theme Store - MIGRATED TO SHARED
 * 
 ...
 * 
 * This wrapper maintains backward compatibility for existing HomePage/shared components.
 * Any component importing from this file will automatically use the shared store.
 * 
 * @version 2.0.0
 * @status Migrated
 ...
 * All HomePage components can continue using these imports
 */
export type {
  ThemeMode,
  ThemePreset,
