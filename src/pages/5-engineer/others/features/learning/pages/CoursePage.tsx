...
const mockCourses: Course[] = [
  {
    ...
    description: 'Master advanced structural analysis techniques and engineering principles',
    longDescription: 'This comprehensive course covers advanced structural analysis methods used in modern engineering. You\'ll learn about finite element analysis, dynamic analysis, and structural optimization techniques. Perfect for engineers looking to advance their structural engineering skills.',
    instructor: {
      name: 'Dr. Ahmed Al-Rashid',
      avatar: '/placeholder.svg',
      rating: 4.8,
      bio: 'Senior Structural Engineer with 15+ years of experience in major infrastructure projects',
      students: 1250,
      courses: 8,
      specialties: ['Structural Analysis', 'Finite Element Analysis', 'Seismic Design']
    },
    duration: '12 hours',
    level: 'Advanced',
    rating: 4.8,
    ...
    videoUrl: '/videos/structural-analysis-intro.mp4',
    progress: 65,
    category: 'Structural Engineering',
    tags: ['Structural Analysis', 'Engineering', 'Advanced', 'FEA'],
    isEnrolled: true,
    isTrending: true,
    curriculum: [
      {
        ...
        lectures: [
          ...
          },
          {
            ...
            isPreview: false,
            isCompleted: true,
            videoUrl: '/videos/math-foundations.mp4'
          },
          {
            id: 'lecture-3',
            title: 'Structural Modeling Techniques',
            duration: '60 min',
            isPreview: false,
            isCompleted: false,
            videoUrl: '/videos/modeling.mp4'
          }
        ]
      },
      {
        ...
        lectures: [
          {
            ...
            isPreview: false,
            isCompleted: false,
            videoUrl: '/videos/fea-fundamentals.mp4'
          },
          {
            id: 'lecture-5',
            ...
            isPreview: false,
            isCompleted: false,
            videoUrl: '/videos/element-types.mp4'
          }
        ]
      }
    ],
    requirements: [
      ...
      'Access to structural analysis software'
    ],
    learningOutcomes: [
      'Master advanced structural analysis techniques',
      'Apply finite element analysis in real projects',
      'Understand dynamic and seismic analysis',
