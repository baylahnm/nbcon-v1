/**
 * Engineer Theme Store - MIGRATED TO SHARED
 * 
 ...
 * 
 * This wrapper maintains backward compatibility for existing engineer code.
 * Any engineer component importing from this file will automatically use the shared store.
 * 
 * @version 2.0.0
 * @status Migrated
 * @migration-date January 15, 2025
 * @backup-file theme-legacy.ts (if rollback needed)
 */

import { useThemeStore as useSharedThemeStore } from '../../../../shared/stores/theme';

/**
 * Engineer Theme Store
 ...
 * All engineer components can continue using these imports
 */
export type {
  ThemeMode,
  ThemePreset,
