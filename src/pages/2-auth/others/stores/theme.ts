/**
 * Auth Theme Store - MIGRATED TO SHARED
 * 
 ...
 * 
 * This wrapper maintains backward compatibility for existing auth code.
 * Any auth component importing from this file will automatically use the shared store.
 * 
 * @version 2.0.0
 * @status Migrated
 ...
 * All auth components can continue using these imports
 */
export type {
  ThemeMode,
  ThemePreset,
