/**
 * Admin Theme Store - MIGRATED TO SHARED
 * 
 ...
 * 
 * This wrapper maintains backward compatibility for existing admin code.
 * Any admin component importing from this file will automatically use the shared store.
 * 
 * @version 2.0.0
 * @status Migrated
 ...
 * All admin components can continue using these imports
 */
export type {
  ThemeMode,
  ThemePreset,
