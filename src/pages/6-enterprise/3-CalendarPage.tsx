        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 pb-4 border-b border-border/40">
          <div className="flex items-center gap-3 min-w-0 flex-1">
            ...
            <div className="min-w-0">
              <h1 className="text-[18px] font-bold tracking-tight">Enterprise Calendar</h1>
        ...
        <div className="flex flex-col lg:flex-row gap-4 mb-0 p-4">
          ...
          <div className="flex gap-2">
            ...
            <Select defaultValue="all">
              <SelectTrigger className="w-[120px] bg-accent hover:bg-accent hover:text-accent-foreground text-foreground">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
