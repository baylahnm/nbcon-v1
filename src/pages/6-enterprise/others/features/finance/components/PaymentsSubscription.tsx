...
// Billing components - placeholder for now
const PlanUpgrade = ({ currentPlan, onPlanSelect, loading }: any) => (
  <div className="p-4 border rounded-lg">
    <p className="text-muted-foreground">Plan upgrade component - to be implemented</p>
  </div>
);
