...
export const NAV: Record<UserRole, NavItem[]> = {
  ...
  enterprise: [
    ...
    { labelKey: "nav.projects", to: "/enterprise/projects", icon: "briefcase" },
    { labelKey: "nav.workforce", to: "/enterprise/workforce", icon: "users" },
    { labelKey: "nav.analytics", to: "/enterprise/analytics", icon: "chart" },
    { labelKey: "nav.finance", to: "/enterprise/finance", icon: "wallet" },
    { labelKey: "nav.compliance", to: "/enterprise/compliance", icon: "shield" },
